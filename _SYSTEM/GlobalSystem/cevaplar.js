let prefix = `${client.guilds.cache.get(global.sistem.SUNUCU.GUILD).emojiGöster(emojiler.no_munur)}`

module.exports = {
    prefix,
    yetersiz:          ``,
    bot:           `Belirtilen kullanıcı bot olduğu için işlem iptal edildi. ${prefix}`,
    üye:           `Bir üye etiketle ve tekrardan dene!`,
    ...
    cezaliramalcim:     `Belirtilen kullanıcı cezalı olduğu için işleme devam edilemiyor. ${prefix}`,
    ...
    bokyolu: `Kullanım hakkınız dolduğu için işleminiz iptal edildi. ${prefix}` 
