...
exports.GiveawayMessages = {
    giveaway: `<:munur_giveaway:997955638195929279> <:munur_giveaway:997955638195929279> **ÇEKİLİŞ VAKTİ** <:munur_giveaway:997955638195929279> <:munur_giveaway:997955638195929279>`,
    giveawayEnded: '<:munur_giveaway:997955638195929279> <:munur_giveaway:997955638195929279> **ÇEKİLİŞ BİTİRİLDİ** <:munur_giveaway:997955638195929279> <:munur_giveaway:997955638195929279>',
    inviteToParticipate: 'Katılmak için <:munur_giveaway:997955638195929279> tepkiye basın!',
    winMessage: 'Tebrikler!, {winners}! **{this.prize}** kazandın! <a:KonfetiGif:947548357793050664>\n{this.messageURL}',
    drawing: 'Kalan Zaman: {timestamp}',
    dropMessage: 'İlk tepki veren siz olun <:munur_giveaway:997955638195929279> !',
...
exports.PauseOptions = {
    isPaused: false,
    content: '⚠️ **ÇEKİLİŞ DURDURULDU !** ⚠️',
    unPauseAfter: null,
    embedColor: '#FFFF00',
...
exports.GiveawaysManagerOptions = {
    ...
    default: {
        ...
        lastChance: {
            enabled: false,
            content: '⚠️ **GİRİŞ İÇİN SON ŞANS !** ⚠️',
            threshold: 5000,
            embedColor: '#FF0000'
        }
    }
...
exports.GiveawayRerollOptions = {
    winnerCount: null,
    messages: {
        congrat: '<:munur_giveaway:997955638195929279> Yeni kazanan(lar): {winners}! Tebrikler, sen kazandın **{this.prize}**!\n{this.messageURL}',
        error: 'Geçerli katılım yok!',
