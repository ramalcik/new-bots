    ...
    static async fetch(id) {
        ...
        try {
            ...
            if(Data) {
                ...
                emojiler = client._emojis = global.emojiler = global._emojis = require('../GlobalSystem/emojiler.json');
                cevaplar = client._reply = global.cevaplar = global._reply = require('../GlobalSystem/cevaplar');
            } else {
                await GUILDS_SETTINGS.updateOne({guildID: id}, {$set: { _id: 1 }}, {upsert: true})
                client.logger.log(`${black.bgHex('#D9A384')(client.botİsmi.toUpperCase())} Sunucu verisi oluşturulmadığından, tekrardan oluşturuldu.`,"warn")
            }
        } catch (err) {}
