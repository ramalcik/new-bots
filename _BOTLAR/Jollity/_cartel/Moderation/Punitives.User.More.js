...
module.exports = {
    ...
    Kullanim: "cezaişlemleri <@munur/ID>",
  ...
  onRequest: async function (client, message, args) {
    ...
    let atılanCezalar = await Punitives.find({Staff: ramalcim.id})
    if(!atılanCezalar) return message.reply({content: `${cevaplar.prefix} ${ramalcim} isimli üyenin daha önce yaptırım uyguladığı ceza-i işlem bulunamadı.`});
