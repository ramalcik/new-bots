...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    if(sunucudabul) {
        ...
        ramalcim.addPunitives(2, message.member, sebep, message)
        ...
        await message.channel.send(`${message.guild.emojiGöster(emojiler.Yasaklandı)} ${ramalcim.toString()} isimli üyeye \`${sebep}\` sebebiyle "__Yasaklama__" türünde ceza-i işlem uygulandı. (\`Ceza Numarası: #${cezano}\`)`)
