...
const Kalkmaz = require('../../../../_SYSTEM/Databases/Schemas/Punitives.Forcebans');
...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    if(kalkmazYasaklama) {
        ...
        kalkmazYasaklama.forEach(async (ramalcim) => {
            let hesap = await client.getUser(ramalcim._id)
            forceBanList += `#${ramalcim.No} | ${hesap.tag} (${hesap.id})\n`
        })
