...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    embed.setFooter("işlem yapılmaz ise otomatik olarak 30 saniye içerisinde silinecek.")
        ...
        if(i.customId == "wentyninbabannesi") {
          ...
          if(etkinlik == "youtube") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'youtube').then(async invite => {
              embed.setDescription(`${message.member} tarafından Youtube Together seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
          ...
          if(etkinlik == "poker") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'poker').then(async invite => {
              embed.setDescription(`${message.member} tarafından Poker Night seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "chess") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'chess').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Satranç seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "checkers") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'checkers').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Checkers seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "betrayal") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'betrayal').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Betrayal seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "fishing") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'fishing').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Fishing seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "lettertile") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'lettertile').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Lettertile seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "wordsnack") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'wordsnack').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Wordsnack seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "doodlecrew") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'doodlecrew').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Doodlecrew seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "spellcast") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'spellcast').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Spellcast seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "awkword") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'awkword').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Awkword seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
          ...
          if(etkinlik == "puttparty") {
            client.discordTogether.createTogetherCode(message.member.voice.channel.id, 'puttparty').then(async invite => {
              embed.setDescription(`${message.member}, tarafından Puttparty seçildi!`).setFooter("bu davet 10 saniye içerisinde silinecektir.")
              msg.edit({embeds: [embed], components: []})
              setTimeout(() => {
                msg.delete().catch(err => {})
              }, 10000);
