...
module.exports = () => {
    ...
    setInterval( async () => {
        let channels = guild.channels.cache.filter(channel => channel.type == "GUILD_VOICE" && channel.members.size > 0 && channel.parent && _statSystem.accessPointChannels.includes(channel.parentId));
